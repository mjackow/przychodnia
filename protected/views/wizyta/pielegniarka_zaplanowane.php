...
$this->widget('zii.widgets.grid.CGridView3', array(
	...
	'columns'=>array(
		...
		array(
			'name'=>'pracownik_imie',
			'value'=>'$data->pracownikIdPracownik->imie',
			),
		array(
			'name'=>'pracownik_imie_drugie',
			'value'=>'$data->pracownikIdPracownik->imie_drugie',
			),
		array(
			'name'=>'pracownik_nazwisko',
			'value'=>'$data->pracownikIdPracownik->nazwisko',
			),
		array(
